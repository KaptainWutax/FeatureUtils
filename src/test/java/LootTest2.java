...
public class LootTest2 {
	...
	public static LootChest TREASURE_CHEST = new LootChest(
			LootChest.stack(Item.EMERALD, EQUAL_TO, 24),
			LootChest.stack(Item.IRON_INGOT, MORE_OR_EQUAL_TO, 26)
	);
	...
	public static void main(String[] args) {
		...
		for(long seed = 0; seed < 1L << 48; seed++) {
			...
			for(int chunkX = 0; chunkX < 200; chunkX++) {
				for(long structureSeed: new ChunkRandomReverser().reversePopulationSeed((seed ^ LCG.JAVA.multiplier) - 30001L,
